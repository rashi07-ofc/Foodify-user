...
import { getNearbyRestaurants } from "../../../api/restaurentFetchAPI.ts";
              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div className="text-center lg:text-left space-y-6">
                  ...
                  <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto lg:mx-0">
                    ...
                    so you can enjoy fresh, delicious meals delivered right to your door.
                  </p>
            ...
            <div className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
              <div className="max-w-7xl mx-auto">
                <div className="mb-8">
                  ...
                  <p className="text-gray-600 text-lg">Fresh from our live data feed</p>
                </div>
                ...
                {loading && (
                  <div className="flex flex-col items-center justify-center py-16">
                    <div className="relative">
                      ...
                      <div className="absolute inset-0 rounded-full h-16 w-16 border-4 border-transparent border-t-red-500 animate-spin" style={{ animationDelay: '0.5s' }}></div>
                    </div>
                    <p className="mt-4 text-gray-600 font-medium">Discovering amazing restaurants near you...</p>
                  </div>
                )}
                        ...
                        >
                          <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 group-hover:border-orange-200">
                            <RestaurantCard 
                              ...
                              imageUrl={`https://images.unsplash.com/photo-${Math.floor(Math.random() * 1000000)}?auto=format&fit=crop&w=400&h=250&crop=entropy`}
                            />
                          </div>
                        </div>
                      ))
            ...
            <div className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-white">
              <div className="max-w-7xl mx-auto">
                <div className="mb-8">
                  ...
                  <p className="text-gray-600 text-lg">Curated selection of top-rated restaurants</p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8">
                  {filteredRestaurants.length > 0 ? (
                    ...
                    <div className="col-span-full text-center py-16">
                      ...
                      <h3 className="text-xl font-semibold text-gray-700 mb-2">No restaurants match your filters</h3>
                      <p className="text-gray-500">Try clearing some filters to see more options</p>
                    </div>
                  )}
                </div>
              </div>
