    ...
    <footer className="bg-gray-100 text-gray-800 pt-10 pb-5 mt-16 border-t">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-5 gap-10 text-sm">
        ...
        <div className="col-span-2 space-y-4">
          <h2 className="text-2xl font-bold text-orange-600">FoodieFy</h2>
          <div className="flex items-center space-x-6 text-gray-600">
            <div className="flex items-center gap-2">
              <FaGlobeAsia className="text-lg text-orange-500" />
              <span>Country: India</span>
            </div>
            <div className="flex items-center gap-2">
              <FaLanguage className="text-lg text-orange-500" />
        ...
        {/* About */}
        <div>
          <h4 className="font-semibold mb-3 text-orange-500">Company</h4>
        ...
        {/* Services */}
        <div>
          <h4 className="font-semibold mb-3 text-orange-500">Our Services</h4>
          <ul className="space-y-2 text-gray-600">
            <li className="hover:text-orange-500 cursor-pointer">Order Online</li>
            <li className="hover:text-orange-500 cursor-pointer">Table Booking</li>
            <li className="hover:text-orange-500 cursor-pointer">Corporate Orders</li>
            <li className="hover:text-orange-500 cursor-pointer">Restaurant Partners</li>
          </ul>
        </div>

        {/* Legal */}
        <div>
          <h4 className="font-semibold mb-3 text-orange-500">Legal</h4>
          <ul className="space-y-2 text-gray-600">
