...
const ComplaintPopup: React.FC<ComplaintPopupProps> = ({ restaurantId,orderId,onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
        <h2 className="text-xl font-semibold mb-4 text-orange-600">Submit a Complaint</h2>
